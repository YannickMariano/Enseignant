...
export default function GraphiqueCamembert({ enseignants }) {
  ...
  const data = [
    { name: 'Maximum', population: max, color: '#4CAF50', legendFontColor: '#333', legendFontSize: 13 },
    { name: 'Minimum', population: min, color: '#f44336', legendFontColor: '#333', legendFontSize: 13 },
    { name: 'Autres', population: autre > 0 ? autre : 0.01, color: '#2196F3', legendFontColor: '#333', legendFontSize: 13 },
  ];
...
const styles = StyleSheet.create({
  container: { backgroundColor: '#fff', margin: 10, padding: 16, borderRadius: 10, elevation: 3 },
  title: { fontSize: 16, fontWeight: 'bold', marginBottom: 10, color: '#333', textAlign: 'center' },
